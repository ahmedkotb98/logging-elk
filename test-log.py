...
class Logging(object):
    def __init__(self, logger_name='python-logger',
                 log_stash_host='http://23.102.37.253/',
                 log_stash_upd_port=9600
    ...
    def get(self):
        ...
        self.logger.addHandler(logstash.TCPLogstashHandler(self.log_stash_host,
...
instance = Logging(log_stash_upd_port=9600, log_stash_host='http://23.102.37.253/', logger_name='ahmed')
logger = instance.get()
